        ...
        <>
            ...
            <section className='max-w-[762px] mx-auto px-3 md:px-0 mt-4'>
                ...
                <div className='flex justify-center items-center gap-2 mt-10'>
                    ...
                    />
                    <button className='hover:scale-105 transition-all duration-200 hover:opacity-80'>
                    ...
                    <div className='pb-10 md:pb-20'>
                        <section className='max-w-[762px] mx-auto px-3 md:px-0 mt-4'>
                            <section className='bg-[#fff] px-[34px] mt-[37px] py-[14px] rounded-2xl blr'>
                                ...
                                <p className='font-bold text-[#0F172A]'>Poland Work Visa</p>
                            </section>
                            ...
                            <section className='bg-[#fff] px-5 !pb-5 sm:px-[34px] mt-6 py-[14px] rounded-2xl blr'>
                                <div className='flex justify-between items-center'>
                                    <div>
                                        ...
                                        <p className='font-bold text-[#0F172A]'>220615V5UTVXJ</p>
                                    </div>
                                    <button>
                                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none">
                                ...
                                <div className='flex justify-between'>
                                    <div>
                                        ...
                                        <p className='font-medium text-[#94A3B8] mt-1'>A***** K******</p>
                                    </div>
                                    <div>
