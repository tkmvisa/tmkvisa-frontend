    ...
    return (
        <>
            ...
            <section className='max-w-[762px] mx-auto px-3 md:px-0 mt-4'>
                <h2 className='font-semibold text-2xl text-center'>{t?.title}</h2>
                    ...
                    <div className='pb-10 md:pb-20'>
                        <section className='max-w-[762px] mx-auto px-3 md:px-0 mt-4 font_man'>
                            <section className='bg-[#fff] px-[34px] mt-[37px] py-[14px] rounded-2xl blr'>
                                <p className='text-[#909090] font-medium'>{t?.service_type}</p>
                            ...
                            <section className='bg-[#fff] px-5 !pb-5 sm:px-[34px] mt-6 py-[14px] rounded-2xl blr'>
                                <div className='flex justify-between items-center'>
                                    <div>
                                        <p className='text-[#909090] text-sm font-medium'>{t?.application_number}</p>
                                ...
                                <h6 className='mt-6 mb-3 font-bold text-[17px] text-[#0F172A]'>{t?.customer_details}</h6>
                            ...
                            <section className='bg-[#fff] px-[20px] mt-[37px] py-[14px] rounded-2xl blr'>
                                <h6 className='font-bold text-[17px] text-[#0F172A] pb-4 mt-1'>{t.title}</h6>
                                <hr />
                                <div className='sm:px-[14px]'>
                                    <ApplicationTimeline data={applicationRes} t={t?.Application_status} status={applicationRes?.Application_Status}/>
                                </div>
                            </section>
            ...
            <footer className='bg-[#9747FF] py-[50px] '>
                <div className='max-w-[1200px] mx-auto px-3 flex flex-col gap-3 md:flex-row justify-center md:justify-between items-center'>
                    <h3 className='text-2xl sm:text-4xl font-semibold max-w-[475px] text-pure text-center md:text-left'>{t?.footer_title}</h3>
