        ...
        <aside className="max-w-[280px] w-full border-r border-border px-8 py-6 h-screen">
            ...
            <List>
                ...
                <ListItem sx={{ display: "flex", alignItems: "center", gap: "10px", padding: '16px', paddingLeft: 0, paddingRight: 0 }}>
                    ...
                    <h4 className="text-sm !font-bold !font-man">Dashboard</h4>
                </ListItem>
                ...
                <ListItem onClick={handleClick} className="!cursor-pointer" sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "10px", padding: '16px', paddingLeft: 0, paddingRight: 0 }}>
                    <div className="flex cursor-pointer items-center gap-[10px]">
                        ...
                        <h4 className="text-sm !font-bold !font-man">Clients</h4>
                    </div>
                    {open ?
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <Collapse in={open} timeout="auto" className="pl-2" unmountOnExit>
                    <List component="div" className="border-l-[2px] border-border" disablePadding>
                        <ListItem button sx={{ pl: 2  }} className="hover:!bg-transparent py-4">
                            <h4 className="text-sm relative !font-bold -text--text-gray !font-man hover:text-primary">
                                Applications
                        ...
                        <ListItem button sx={{ pl: 2 }} className="hover:!bg-transparent !pb-0 pt-4">
                            <h4 className="text-sm !font-bold -text--text-gray relative !font-man hover:text-primary">
                                Client List
                                <div className="bg-transparent absolute -left-[18px] -top-1 rounded-bl-[8px] border-[2px] border-t-0 border-r-0 border-border h-4 w-3"/>    
                            </h4>
                        </ListItem>
